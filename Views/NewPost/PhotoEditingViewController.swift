...
class PhotoEditingViewController: UIViewController {
    ...
    // MARK: Filters
    let exposureFilter = Filter(filterType: .exposure,
                                filterName: "CIExposureAdjust",
                                filterKey: kCIInputEVKey,
                                filterDefaultValue: 0.0 as Float,
                                minimumValue: -1.0,
                                maximumValue: 1.0)

    let brightnessFilter = Filter(filterType: .brightness,
                                  filterName: "CIColorControls",
                                  filterKey: kCIInputBrightnessKey,
                                  filterDefaultValue: 0 as Float,
                                  minimumValue: -0.15,
                                  maximumValue: 0.15)

    let contrastFilter = Filter(filterType: .contrast,
                                filterName: "CIColorControls",
                                filterKey: kCIInputContrastKey,
                                filterDefaultValue: 1 as Float,
                                minimumValue: 0.8,
                                maximumValue: 1.2)

    let saturationFilter = Filter(filterType: .saturation,
                                  filterName: "CIColorControls",
    ...
    let warmthFilter = Filter(filterType: .warmth,
                              filterName: "CITemperatureAndTint",
                              filterKey: "inputTargetNeutral",
                              filterDefaultValue: CIVector(x: 6500, y: 0),
                              minimumValue: -3000,
                              maximumValue: 3000)

    let tintFilter = Filter(filterType: .tint,
                            filterName: "CITemperatureAndTint",
                            filterKey: "inputTargetNeutral",
                            filterDefaultValue: CIVector(x: 6500, y: 0),
                            minimumValue: -100,
    ...
    let highlightsFilter = Filter(filterType: .highlihts,
    ...
    let shadowsFilter = Filter(filterType: .shadows,
                               filterName: "CIHighlightShadowAdjust",
    ...
    let vignetteFilter = Filter(filterType: .vignette,
    ...
    init(photo: UIImage, isWidthDominant: Bool, ratio: CGFloat) {
        ...
        currentFilter = Filter(filterType: .exposure,
                               filterName: "CIExposureAdjust",
                               filterKey: kCIInputEVKey,
    ...
    private func setupNavBar() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Next",
                                                            style: .done,
                                                            target: self,
                                                            action: #selector(didFinishEditingPhoto))
    ...
    private func userHasSelectedFilter(filter: Filter?, filterName: String, filterDefaultValue: Any, sliderMinimumValue: Float, sliderMaximumValue: Float) {
        ...
        case .tint:
            sliderDefaultValue = 0
        default:
            sliderDefaultValue = filterDefaultValue as? Float ?? 0
        }

        filterValue = filterDefaultValue

        let sliderView = PhotoEffectSliderView(sliderDefaultValue: sliderDefaultValue,
                                               sliderMaximumValue: sliderMaximumValue,
                                               sliderMinimumValue: sliderMinimumValue,
                                               effectName: filterName,
                                               key: kCIInputEVKey,
...
extension PhotoEditingViewController: PhotoEffectsHorizontalScrollViewDelegate, PhotoEffectSliderDelegate {
    ...
    func showExposureSlider() {
        ...
        userHasSelectedFilter(filter: exposureFilter,
                              filterName: "Exposure",
                              filterDefaultValue: exposureFilter.defaultValue,
                              sliderMinimumValue: exposureFilter.minimumValue,
                              sliderMaximumValue: exposureFilter.maximumValue)
    }

    func showBrightnessSlider() {
        brightnessFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: brightnessFilter,
                              filterName: "Brightness",
                              filterDefaultValue: brightnessFilter.defaultValue,
                              sliderMinimumValue: brightnessFilter.minimumValue,
                              sliderMaximumValue: brightnessFilter.maximumValue)
    }

    func showContrastSlider() {
        contrastFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: contrastFilter,
                              filterName: "Contrast",
                              filterDefaultValue: contrastFilter.defaultValue,
                              sliderMinimumValue: contrastFilter.minimumValue,
                              sliderMaximumValue: contrastFilter.maximumValue)
    }

    func showSaturationSlider() {
        saturationFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: saturationFilter,
                              filterName: "Saturation",
                              filterDefaultValue: saturationFilter.defaultValue,
                              sliderMinimumValue: saturationFilter.minimumValue,
                              sliderMaximumValue: saturationFilter.maximumValue)
    }

    func showWarmthSlider() {
        warmthFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: warmthFilter,
                              filterName: "Warmth",
                              filterDefaultValue: warmthFilter.defaultValue,
                              sliderMinimumValue: warmthFilter.minimumValue,
                              sliderMaximumValue: warmthFilter.maximumValue)
    }

    func showTintSlider() {
        tintFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: tintFilter,
                              filterName: "Tint",
                              filterDefaultValue: tintFilter.defaultValue,
                              sliderMinimumValue: tintFilter.minimumValue,
                              sliderMaximumValue: tintFilter.maximumValue)
    }

    func showHighlightsSlider() {
        highlightsFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: highlightsFilter,
                              filterName: "Highlights",
                              filterDefaultValue: highlightsFilter.defaultValue,
                              sliderMinimumValue: highlightsFilter.minimumValue,
                              sliderMaximumValue: highlightsFilter.maximumValue)
    }

    func showShadowsSlider() {
        shadowsFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: shadowsFilter,
                              filterName: "Shadows",
                              filterDefaultValue: shadowsFilter.defaultValue,
                              sliderMinimumValue: shadowsFilter.minimumValue,
                              sliderMaximumValue: shadowsFilter.maximumValue)
    }

    func showVignetteSlider() {
        vignetteFilter.setInputImage(image: modifiedImage)
        userHasSelectedFilter(filter: vignetteFilter,
                              filterName: "Vignette",
                              filterDefaultValue: vignetteFilter.defaultValue,
                              sliderMinimumValue: vignetteFilter.minimumValue,
                              sliderMaximumValue: vignetteFilter.maximumValue)
    }
    ...
    func saveFilterApplication(view: UIView) {
        guard let outputImage = currentFilter.getOutput(),
