...
class NewPostProgressView: UIView {
    ...
    let progressBar: UIProgressView = {
        ...
        progressBar.progressTintColor = Colors.coolBlue
        progressBar.trackTintColor = Colors.progressBarTrackTint
        return progressBar
    }()
    ...
    init(photo: UIImage?, username: String) {
        ...
        self.postingToUsernameLabel.text = String(localized: "Posting to \(username)")
